...
if(isset($_POST['add'])){
   ...
   $rate=mysqli_query($conn, "SELECT * FROM `food_tbl` WHERE food_name='$food'") or die('query failed');
   ...
   mysqli_query($conn,"UPDATE food_tbl SET rating='$avg', response='$r' WHERE food_name='$food'");
}
                  ...
                  if(mysqli_num_rows($select_foods) > 0){
                     while($fetch_foods = mysqli_fetch_assoc($select_foods)){
                       ...
                       <form action="" method="post" class="box">
                           ...
                           <a href="orders.php?customize=<?php echo $fetch_foods['food_name']; ?>" class="delete-btn" >Customize</a> 
                           <form action ="" method="post">
                              ...
                              <input type="hidden" name="food_name" value="<?php echo $fetch_foods['food_name']; ?>">
                              <div class="inputBox"><input type="submit" name="add" value="Rating" class="rate-btn"> </div>
   ...
   <form action="" method="post"   enctype="multipart/form-data">
         ...
         <div class="box" id="checkbox">
           <h4>Add something extra :</h4>
            ...
            <li type="none"><input type="checkbox" name="toppings[]" value="<?php echo $fetch_custom['toppings']; ?>"><?php echo " ".$fetch_custom['toppings']." ".$fetch_custom['price'].'<br>'; ?></li>
