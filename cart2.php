...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <a href="cart2.php?delete=<?php echo $fetch_cart_tbl['cart_id']; ?>" class="fas fa-times" onclick="return confirm('Do you want to delete?');"></a>
         ...
         <div class="sub-total"> <?php echo $fetch_cart_tbl['size'] ?> <span><?php echo "=".$fetch_cart_tbl['p_price']?>/-</span> </div>
         <div class="sub-total"> <?php echo $fetch_cart_tbl['toppings'] ?> <span><?php echo "=".$fetch_cart_tbl['t_price']?>/-</span> </div>
   ...
   <div style="margin-top: 20px; text-align:center;">
      <a href="cart2.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('delete all from cart?');">delete all</a>
   </div>
   ...
   <div class="cart-total">
      ...
      <div class="add-more">
        ...
        <?php
             ...
             <form method="post">
                  <input type="hidden" name="points" class="box" value="<?php echo $fetch_points['star_points']; ?>">
                  <input type="submit" name="stars" value="Use star points" class="home-btn <?php echo ($fetch_points['star_points'] > 0)?'':'hidden'; ?>"/>
                        ...
                        if(isset($_POST['stars'])) {
                           ...
                           $_SESSION['point'] = $fetch_points['star_points'];
 ...
 ?>
      ...
      <div class="flex">
         <a href="order_details.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Proceed To Check Out</a>
      </div>
